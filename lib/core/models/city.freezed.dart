...
abstract class $CityCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'city') String cityName});
}
...
class _$_City implements _City {
  _$_City(
      ...
      @JsonKey(name: 'city') required this.cityName});
  ...
  @override
  String toString() {
    return 'City(id: $id, districtId: $districtId, cityName: $cityName)';
  }
...
abstract class _City implements City {
  factory _City(
      ...
      @JsonKey(name: 'city') required final String cityName}) = _$_City;
