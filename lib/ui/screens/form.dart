    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title:Container(
            ...
            child: Text("Post a Full Time Job".toUpperCase(), style: const TextStyle(
                fontSize: 20,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("Switch Job Type".toUpperCase(), style:TextStyle(
                ...
                child: Column(
                  children:[
                    ...
                    Padding(
                      ...
                      child: Text("Job Requirements".toUpperCase(),style: TextStyle(
                        shadows: [
                          Shadow(
                              color: Colors.black,
                              offset: Offset(0, -5))
                            ...
                            child: Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text("Select Experience".toUpperCase(),style: TextStyle(
                            shadows: [
                            Shadow(
                            color: Colors.black,
                            offset: Offset(0, -5))
                  ...
                  decorationThickness: 4,
                            ...
                            child: Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text("Select Education".toUpperCase(),style: TextStyle(
                                    shadows: [
                                      Shadow(
                                          color: Colors.black,
                                          offset: Offset(0, -5))
                          ...
                          child: Container(
                            ...
                            child:Row(
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsets.all(20),
                                  child: Text("Select Salary".toUpperCase(),style: TextStyle(
                                    shadows: [
                                      Shadow(
                                          color: Colors.black,
                                          offset: Offset(0, -5))
                    ...
                    Padding(
                      ...
                      child: Card(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text("Note: The job details cannot be modified  after the job is posted.",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 9.7), ),
                          )),
                    ),
                    SizedBox(
                      height: 10,
                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        ...
                        child:Text("Post".toUpperCase(),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22,color: Colors.white70),) ,),
                    )
                  ],
                ),
              ),
