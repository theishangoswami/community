...
class _SettingState extends State<Setting> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xFF5A3FCE),
        title: Text("Settings".toUpperCase(),style: TextStyle(color:Colors.black),),),
      body: SettingsList(
        sections: [
          SettingsSection(
            title: Text('Common'.toUpperCase().toUpperCase(),style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500,color:Color(0xFF5A3FCE)),),
            tiles: <SettingsTile>[
          ...
          SettingsSection(
            title: Text('About '.toUpperCase(),style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500,color:Color(0xFF5A3FCE)),),
            tiles: <SettingsTile>[
              SettingsTile.navigation(
          ...
          SettingsSection(
            title: Text('Account'.toUpperCase(),style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500,color:Color(0xFF5A3FCE)),),
            tiles: <SettingsTile>[
              SettingsTile.navigation(
